...
void LuaScriptInterface::registerFunctions()
{
	...
	//sha1(string)
	lua_register(luaState, "sha1", LuaScriptInterface::luaSha1);
...
int LuaScriptInterface::luaSha1(lua_State* L)
{
	// sha1(string) -> 40-char lowercase hex digest (used for account passwords)
